...
export const views: ViewRoute[] = [
  ...
  },
  {
    ...
    action: async (_context, _command) => {
      await import('./views/masterdetaillit/master-detail-lit-view');
      return;
    },
  },
  {
    ...
    action: async (_context, _command) => {
      await import('./views/masterdetailsampleaddresslit/master-detail-sample-address-lit-view');
      return;
    },
  },
  {
    ...
    action: async (_context, _command) => {
      await import('./views/masterdetailsamplebooklit/master-detail-sample-book-lit-view');
      return;
    },
  },
];
